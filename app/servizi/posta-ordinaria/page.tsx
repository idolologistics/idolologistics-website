...
export const metadata = {
  title: "Posta ordinaria | IDOLO LOGISTICS",
  description: "Scopri il servizio di posta ordinaria di IDOLO LOGISTICS.",
};

export default function PostaOrdinariaPage() {
  return (
      ...
      <main className="mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-6 sm:px-8 lg:px-10">
        <Card className="border border-black/5 bg-white p-8 sm:p-10 lg:p-12">
          ...
          <p className="mt-5 max-w-2xl text-base leading-8 text-zinc-600 sm:text-lg">
            Per la corrispondenza quotidiana, garantiamo una gestione ordinata, rapida e affidabile per privati e aziende.
          </p>
