...
export const metadata = {
  title: "Spedizioni nazionali | IDOLO LOGISTICS",
  description: "Scopri le spedizioni nazionali di IDOLO LOGISTICS.",
};

export default function SpedizioniNazionaliPage() {
  return (
      ...
      <main className="mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-6 sm:px-8 lg:px-10">
        <Card className="border border-black/5 bg-white p-8 sm:p-10 lg:p-12">
          ...
          <p className="mt-5 max-w-2xl text-base leading-8 text-zinc-600 sm:text-lg">
            Scegli una soluzione logistica puntuale e affidabile per invii in tutta Italia, con assistenza dedicata dal primo contatto alla consegna.
          </p>
