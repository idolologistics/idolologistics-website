...
export const metadata = {
  title: "Servizi per aziende | IDOLO LOGISTICS",
  description: "Scopri i servizi per aziende di IDOLO LOGISTICS.",
};
      ...
      <main className="mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-6 sm:px-8 lg:px-10">
        <Card className="border border-black/5 bg-white p-8 sm:p-10 lg:p-12">
          ...
          <p className="mt-5 max-w-2xl text-base leading-8 text-zinc-600 sm:text-lg">
            Per uffici, team e strutture in crescita, organizziamo servizi continui e soluzioni professionali per la gestione della corrispondenza e delle spedizioni.
          </p>
