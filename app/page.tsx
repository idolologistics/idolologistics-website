      ...
      <section className="hero">
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <p className="hero-lead">Servizi postali e logistici affidabili per privati, aziende, professionisti e Pubbliche Amministrazioni. Dalla partenza alla consegna, ci occupiamo noi di tutto.</p>
            ...
            <div className="hero-proof"><span><strong>7</strong> servizi dedicati</span><span><strong>1</strong> referente diretto</span><span><strong>Cagliari</strong> consegne in giornata</span></div>
          </div>
        ...
        <div className="container">
          <div className="sailpost-grid">
            ...
            <div className="sailpost-copy">
              ...
              <p>Facciamo parte della rete postale Sailpost e offriamo a Cagliari servizi di spedizione, raccomandate, consegna, ritiro e soluzioni dedicate a privati, professionisti, aziende e Pubbliche Amministrazioni.</p>
          ...
          <ul className="sailpost-points" aria-label="Vantaggi della rete Sailpost">
            ...
            <li><span>04</span>soluzioni per aziende, professionisti e Pubbliche Amministrazioni</li>
          </ul>
        </div>
      </section>

      <section className="business-section section"><div className="container business-grid"><div className="business-art" aria-hidden="true"><span className="giant-type">B2B</span><div className="document-stack"><div /><div /><div /></div><span className="stamp">PRIORITÀ<br />BUSINESS</span></div><div className="business-copy"><p className="eyebrow eyebrow-dark">Per il tuo lavoro</p><h2>Più tempo per il tuo business. Alla logistica pensiamo noi.</h2><p>Un servizio organizzato per aziende, studi professionali, amministratori di condominio ed enti pubblici che vogliono semplificare la gestione di corrispondenza e spedizioni.</p><ul>{businessBenefits.map((item) => <li key={item}><span aria-hidden="true">✓</span>{item}</li>)}</ul><Link className="button button-light" href="/aziende-professionisti">Scopri le soluzioni business e PA <span aria-hidden="true">→</span></Link></div></div></section>
